...
const CategorySidebar = () => {
    ...
    const loadMenuStructure = async () => {
        try {
            ...
            console.log('🔍 Menu structure loaded:', structure);
    ...
    const navigateToProducts = (category, brand = null) => {
        ...
        // Solo agregar brand si específicamente se selecciona
        if (brand) {
            params.append('brand', brand);
        }
        // Si no hay brand, asegurarse de que no esté en la URL
                    ...
                    {isMenuOpen && (
                        <div className="absolute top-full left-4 right-4 mt-3 bg-white rounded-2xl shadow-2xl border border-gray-200 z-50 max-h-80 overflow-y-auto">
                            <div className="p-5 space-y-4">
                                {menuStructure.categories.map((category, index) => (

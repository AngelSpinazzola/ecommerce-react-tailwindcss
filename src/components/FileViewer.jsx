...
const FileViewer = ({ isOpen, onClose, orderId, fileType, fileName }) => {
    ...
    const loadFile = async () => {
        try {
            ...
            // Usar el nuevo endpoint view-receipt
    ...
    const downloadFile = async () => {
        try {
            // Usar el endpoint de descarga original
                ...
                <div className="flex items-center justify-between p-4 border-b">
                    <div>
                        ...
                        <p className="text-sm text-gray-500">
                            {fileType === 'pdf' ? '📄 Documento PDF' : '🖼️ Imagen'}
                        </p>
                    </div>

...
const Cart = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-100 font-montserrat">
            ...
            {/* Main Content */}
            <div className="pt-32 sm:pt-28 px-4 sm:px-6 lg:px-8">
                <div className="max-w-6xl mx-auto">
                    {/* Header fuera de la card */}
                    <div className="mb-6 text-left">
                        <h1 className="font-poppins text-xl sm:text-2xl font-semibold text-gray-800 mb-3">
                            Mi carrito
                        </h1>
                        <div className="h-px bg-gray-300 w-full mb-6"></div>
                    </div>
                    {/* Card blanca */}
                    <main className="px-4 sm:px-6 lg:px-8 pb-12 lg:pb-16 pt-4">
                        {cartItems.length === 0 ? (
                            /* Carrito vacío */
                            <div className="text-center py-20">
                                ...
                                <h3 className="font-poppins text-xl font-semibold text-gray-800 mb-4">Tu carrito está vacío</h3>
                                <p className="font-poppins text-sm text-gray-500 mb-8 max-w-md mx-auto leading-relaxed">
                                    ¡Es hora de armar tu setup gaming perfecto!
                                </p>
                                <div className="mt-6">
                                    <Link
                                        to="/"
                                        className="inline-flex items-center px-6 py-3 bg-indigo-600 text-white font-poppins font-semibold rounded-lg transition-colors hover:bg-indigo-700"
                                    >
                                        ...
                                        <div className="relative bg-white rounded-xl border border-gray-200 p-8">
                                            ...
                                            <div className="mt-8 p-4 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl border border-blue-100">
                                                <div className="flex items-center">
                                                    ...
                                                    <div>
                                                        <h3 className="font-poppins text-sm font-semibold text-blue-900">Método de pago</h3>
                                                        <p className="font-poppins text-sm text-blue-700">Transferencia bancaria</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="mt-8">
                                                <button
                                                    ...
                                                    className={`w-full py-3 sm:py-4 px-6 font-poppins text-sm sm:text-base font-semibold rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 ${cartItems.length === 0
                                            ...
                                            <div className="mt-8 text-center">
                                                <Link
                                                    to="/"
                                                    className="font-poppins inline-flex items-center text-purple-600 hover:text-purple-700 font-medium transition-colors text-sm"
                                                >
                                                    <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" />
                                                    </svg>
